...
[Note] For Unity versions from 2019.3.0b4 to 2022.2.0a17 use [19LTS-21LTS branch](https://github.com/Unity-Technologies/uaal-example/tree/uaal-example/19LTS-21LTS). For Unity versions from 2022.2.0a17 to 2023.1.0a16 use [22LTS branch](https://github.com/Unity-Technologies/uaal-example/tree/uaal-example/22LTS). When you use Activity instead of GameActivity in Unity version 2023.1.0a20 or later, use [23LTS-UnityPlayerActivity](https://github.com/Unity-Technologies/uaal-example/tree/uaal-example/23LTS-UnityPlayerActivity).
...
- Go to Player Settings window (click Player Settings button at the bottom left corner of Build Settings or use Edit / Project Settings menu and choose Player tab on the left)
  ...
  - In Other Settings -> Configuration section -> select GameActivity as Application Entry Point
