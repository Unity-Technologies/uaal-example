...
- (void)viewDidLoad
{
    ...
    self.unityInitBtn.frame = CGRectMake(0, 0, 350, 80);
    self.unityInitBtn.center = CGPointMake(200, 120);
    ...
    self.unpauseBtn.frame = CGRectMake(0, 0, 350, 80);
    self.unpauseBtn.center = CGPointMake(600, 120);
    ...
    self.unloadBtn.frame = CGRectMake(0, 0, 350, 80);
    self.unloadBtn.center = CGPointMake(1000, 120);
    ...
    self.quitBtn.frame = CGRectMake(0, 0, 350, 80);
    self.quitBtn.center = CGPointMake(1000, 220);
...
- (void)initUnity
{
    ...
    if(self.showUnityOffButton == nil) {
        ...
        self.showUnityOffButton.frame = CGRectMake(0, 0, 300, 80);
        self.showUnityOffButton.center = CGPointMake(200, 250);
        ...
        self.btnSendMsg.frame = CGRectMake(0, 0, 300, 80);
        self.btnSendMsg.center = CGPointMake(600, 250);
        ...
        self.unloadBtn = [UIButton buttonWithType: UIButtonTypeSystem];
        [self.unloadBtn setTitle: @"Unload" forState: UIControlStateNormal];
        self.unloadBtn.frame = CGRectMake(0, 0, 300, 80);
        self.unloadBtn.center = CGPointMake(1000, 250);
        self.unloadBtn.backgroundColor = [UIColor redColor];
        ...
        self.quitBtn = [UIButton buttonWithType: UIButtonTypeSystem];
        [self.quitBtn setTitle: @"Quit" forState: UIControlStateNormal];
        self.quitBtn.frame = CGRectMake(0, 0, 300, 80);
        self.quitBtn.center = CGPointMake(1000, 350);
        self.quitBtn.backgroundColor = [UIColor redColor];
